      ...
      if (arrCategoriesListing.length > 0) {
        ...
        return (
          <div className="ss-frontend-categories-listing-container">
            {arrCategoriesListing.map((categoriesRow, categoriesRowKey) => {
              return (
                <article key={categoriesRowKey} className="ss-frontend-categories-container" style={{ '--categoriesListingDesktopContainerBG': 'url(/files-layout/layout-desktop-categories-container-bg' + (categoriesRowKey + 1) + '.png)', '--categoriesListingMobileContainerBG': 'url(/files-layout/layout-mobile-categories-container-bg' + (categoriesRowKey + 1) + '.png)' }}>
                  <a href={`/${SyncSystemNS.FunctionsGeneric.categoryConfigSelect(categoriesRow.category_type, 1) + '/' + categoriesRow.id}`} className="ss-frontend-categories-listing-image01" style={{ backgroundImage: 'url(' + gSystemConfig.configFrontendReactURLImages + gSystemConfig.configDirectoryFilesSD + '/t' + categoriesRow.image_main + ')' }}>

                  </a>
                  <h3 className="ss-frontend-categories-listing-title01">
                    <a href={`/${SyncSystemNS.FunctionsGeneric.categoryConfigSelect(categoriesRow.category_type, 1) + '/' + categoriesRow.id}`} className="ss-frontend-categories-listing-title-link01">
                      {SyncSystemNS.FunctionsGeneric.contentMaskRead(categoriesRow.title, 'db')}
                    </a>
                  </h3>
                  <p className="ss-frontend-categories-listing-text01">
